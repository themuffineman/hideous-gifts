...
fetch("http:localhost:8080/api/create-product", {
  ...
  body:JSON.stringify({
    productName: "Testing new prod",
    productDescription: "Testing new prod",
    bluePrintId: 145,
    providerId:29,
    imageUrl:"https://images.pexels.com/photos/29084208/pexels-photo-29084208/free-photo-of-serene-beachside-woman-holding-wine-glass.jpeg",
